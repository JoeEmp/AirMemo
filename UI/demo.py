...
class Ui_MainWindow(object):
    ...
    def setupLaylout(self, MainWindow):
        #窗口
        records=get_records(config.filename)
        ...
        #窗口大小
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0,config.baseWidth,(len(records)+1)*config.buttonHeight))
        ...
        for i in range(len(get_records(config.filename))):
